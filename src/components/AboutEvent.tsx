export default function AboutEvent() {
  return (
    ...
    >
      <h2 className="font-bold text-[32px] leading-[32px] tracking-[0%] text-night-black mb-5">
        About this event
      </h2>
      ...
      <a
        className="text-primary-blue underline mt-2 font-normal text-[16px] leading-[24px] tracking-[0%]"
        href=""
      >
        Read more
      </a>
